...
-- C	=>  Location: PIN_K12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \g10|z~0_combout\ : std_logic;
...
\g10|z~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \g10|z~0_combout\ = ( \C~input_o\ & ( \D~input_o\ & ( \B~input_o\ ) ) ) # ( !\C~input_o\ & ( \D~input_o\ & ( !\A~input_o\ ) ) ) # ( \C~input_o\ & ( !\D~input_o\ ) ) # ( !\C~input_o\ & ( !\D~input_o\ & ( (!\A~input_o\) # (!\B~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111110011111100111111111111111111001100110011000000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
