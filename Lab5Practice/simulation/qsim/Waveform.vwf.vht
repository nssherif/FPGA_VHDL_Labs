...
-- *****************************************************************************
-- Generated on "03/09/2022 10:51:12"
...
SIGNAL incerementCount : STD_LOGIC;
SIGNAL output : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL reset : STD_LOGIC;
COMPONENT fourBitCounter
	PORT (
	clk : IN STD_LOGIC;
	incerementCount : IN STD_LOGIC;
...
-- list connections between master ports and signals
	clk => clk,
	incerementCount => incerementCount,
	output => output,
	reset => reset
	);
...
-- incerementCount
t_prcs_incerementCount: PROCESS
BEGIN
	incerementCount <= '1';
	WAIT FOR 490000 ps;
	incerementCount <= '0';
WAIT;
END PROCESS t_prcs_incerementCount;
