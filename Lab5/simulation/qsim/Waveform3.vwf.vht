...
-- *****************************************************************************
-- Generated on "03/04/2022 10:15:34"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          Bit10ShiftRegister
-- 
...
ENTITY Bit10ShiftRegister_vhd_vec_tst IS
END Bit10ShiftRegister_vhd_vec_tst;
ARCHITECTURE Bit10ShiftRegister_arch OF Bit10ShiftRegister_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
